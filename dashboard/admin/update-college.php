  ...
  if (isset($_GET['college_name'])) {
	...
	if (isset($_POST['update_college'])) {
		...
		if (empty($collegeName)) {
			...
			$updateCollege = $functions->updateCollege($collegeId, $collegeName);
			if ($updateCollege) {
					...
					<div id="content">
							...
							<div class="container-fluid">
								...
								<div class="d-sm-flex align-items-center justify-content-center mb-4">
									<h1 class="h3 mb-0 text-gray-800">Update College</h1>
								</div>
								<div class="row">
										...
										<form action="update-college.php" method="post">
											<div class="card mt-2">
												<div class="card-header">
													<h6 class="m-0">Update College</h6>
												</div>
												<div class="card-body">
													<div class="form-floating mb-1">
														<strong>College Name:</strong>
														<input type="text" name="college_name" class="form-control" value="<?= $collegeName ?>" placeholder="Enter College Name">
													</div>
													<input type="hidden" name="college_id" value="<?= $collegeId ?>">
													<button type="submit" class="mt-1 btn btn-primary w-100" name="update_college">Update College</button>
												</div>
											</div>
										</form>
									</div>
