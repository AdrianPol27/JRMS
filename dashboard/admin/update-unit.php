  ...
  if (isset($_GET['unit_head'])) {
	...
	if (isset($_POST['update_unit'])) {
		...
		if (empty($unitHead)) {
			...
			$updateUnit = $functions->updateUnit($unitId, $unitName, $unitHead);
			if ($updateUnit) {
							...
							<div class="container-fluid">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										...
										<form action="update-unit.php" method="post">
											<div class="card mt-2">
												<div class="card-header">
													<h6 class="m-0">Update Unit</h6>
												</div>
												<div class="card-body">
													<div class="form-floating mb-1">
														<strong>Unit Name:</strong>
														<input type="text" name="unit_name" class="form-control" value="<?= $unitName ?>" placeholder="Enter Unit Name">
													</div>
													<div class="form-floating mb-1 mt-2">
														<strong>Unit Head:</strong>
														<input type="text" name="unit_head" class="form-control" value="<?= $unitHead ?>" placeholder="Enter Unit Head">
													</div>
													<input type="hidden" name="unit_id" value="<?= $unitId ?>">
													<button type="submit" class="mt-1 btn btn-primary w-100" name="update_unit">Update Unit</button>
												</div>
											</div>
										</form>
									</div>
