  ...
  if (isset($_GET['department_name'])) {
	...
	if (isset($_POST['update_department'])) {
		...
		if (empty($departmentName)) {
			array_push($errors, "Department Name should not be empty!");
		} else {
			$updateDepartment = $functions->updateDepartment($departmentId, $departmentName);
			if ($updateDepartment) {
										...
										<form action="update-department.php" method="post">
											<div class="card mt-2">
												<div class="card-header">
													<h6 class="m-0">Update Department</h6>
												</div>
												<div class="card-body">
													<div class="form-floating mb-1">
														<strong>Department Name:</strong>
														<input type="text" name="department_name" class="form-control" value="<?= $departmentName ?>" placeholder="Enter Department Name">
													</div>
													<input type="hidden" name="department_id" value="<?= $departmentId ?>">
													<button type="submit" class="mt-1 btn btn-primary w-100" name="update_department">Update Department</button>
												</div>
											</div>
										</form>
									</div>
